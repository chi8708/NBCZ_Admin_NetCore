...
{
    public partial class  Pub_UserBLL:IPub_UserBLL
    {
        IPub_UserDAL dal = null;
        IPub_UserRoleBLL userRoleBLL = null;
        IPub_UserFunctionBLL userFunctionBLL =null;

        public Pub_UserBLL(IPub_UserDAL dal, IPub_UserRoleBLL userRoleBLL, IPub_UserFunctionBLL userFunctionBLL)
        {
            this.dal = dal;
