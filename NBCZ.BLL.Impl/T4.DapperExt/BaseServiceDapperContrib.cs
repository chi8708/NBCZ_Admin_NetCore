...
{
    public partial class BaseServiceDapperContrib<T>:IBaseService<T> where T : class, new()
    {
        IBaseData<T> dal = null;
        public BaseServiceDapperContrib()
        {
           dal = new BaseDataDapperContrib<T>();
        }
        //public BaseServiceDapperContrib(IBaseData<T> baseData)
        //{
        //    dal = baseData;
        //}
        /// <summary>
